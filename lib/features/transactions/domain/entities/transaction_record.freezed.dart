...
class _$TransactionRecordImpl implements _TransactionRecord {
  ...
  @override
  String toString() {
    return 'TransactionRecord(id: $id, userId: $userId, type: $type, title: $title, amount: $amount, categoryName: $categoryName, accountId: $accountId, paymentMethod: $paymentMethod, note: $note, createdAt: $createdAt, transactionDate: $transactionDate, updatedAt: $updatedAt)';
  }
